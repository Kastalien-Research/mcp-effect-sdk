...
export const portDiagnostics = [
  {
    ...
    status: "partial",
    local: "examples/typescript-sdk-ports/hosting.ts",
  ...
  },
  {
    ...
    status: "partial",
    local: "examples/everything-client.ts",
  ...
  },
  {
    ...
    local: "examples/core-protocol-catalog.ts",
  ...
  },
  {
    ...
    status: "already-covered",
    local: "examples/typescript-sdk-ports/primitives.ts",
  ...
  },
  {
    ...
    status: "ported",
    local: "examples/typescript-sdk-ports/interactions.ts",
