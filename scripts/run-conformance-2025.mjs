...
const serverPath = process.env.MCP_CONFORMANCE_SERVER_PATH
  ...
  : path.join(root, "dist/examples/everything-server-2025.js")
const evidenceName = evidenceVariant === "published" ? "published-conformance-2025-11-25" : "conformance-2025-11-25"
const evidenceCommand =
  evidenceVariant === "published" ? "published artifact server-all 2025-11-25" : "pnpm run conformance:2025-11-25"
const suite = "all"
...
if (process.argv[1] && fileURLToPath(import.meta.url) === process.argv[1]) {
  NodeRuntime.runMain(runScript("run-conformance-2025", runConformanceSuite))
}
