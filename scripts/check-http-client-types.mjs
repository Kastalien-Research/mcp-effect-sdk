...
const runTypecheck = () => {
  const command = ["pnpm", "exec", "tsc", "--project", "test/types/wp4-http-client/tsconfig.json"]
...
if (process.argv[1] && fileURLToPath(import.meta.url) === process.argv[1]) {
  NodeRuntime.runMain(runScript("scripts/check-http-client-types", () => runTypecheck()))
}
