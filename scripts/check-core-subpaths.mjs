...
const defaultDeclarationExports = new Map([
  [
    ...
    [
      ...
      "ElicitationInputHandlers",
      "InputRequiredContinuation",
      "InputRequiredError",
      "InputRequiredErrorReason",
      "InputRequiredHandlerContext",
      "InputRequiredMode",
      "InputRequiredPolicy",
      "InputRequiredPolicyType",
      ...
      "ProgressHandler",
      "RootsInputHandler",
      "SamplingInputHandler",
      "Subscription",
      "SubscriptionAbruptError",
      "SubscriptionAbruptReason",
      "SubscriptionClosure",
      "SubscriptionFilter",
      "SubscriptionNotification",
      "SubscriptionProtocolError",
      "SubscriptionProtocolReason",
      "make",
...
const declarationExpectations = usesDefaultEntrypoints ? new Map(defaultDeclarationExports) : new Map()
