...
When hitting an escalation threshold, format the escalation as a structured
decision request — not an open-ended question. Present the situation, options,
and tradeoffs. Ask the human to _decide_, not _diagnose_.
...
4. **Options**: At least 2 options, each with label, description, tradeoff, and
   risk level
