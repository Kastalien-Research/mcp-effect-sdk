...
name: implement
description:
  Implement a specification using a TDD-oriented workflow. Extracts
  requirements, generates tests first, then implements to pass the tests.
  Includes spiral detection and acceptance gates.
...
**Spiral detection**: If you find yourself editing the same files 3+ times
without making progress, stop and reassess your approach.
