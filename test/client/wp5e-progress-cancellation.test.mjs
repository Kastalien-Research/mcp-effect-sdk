    ...
    Effect.scoped(
      Effect.gen(function* () {
        ...
        yield* client.callTool(
          { name: "reused", arguments: {} },
          {
            progress: { token: 1 }
          }
        )
        yield* client.callTool(
          { name: "textual", arguments: {} },
          {
            progress: { token: "1" }
          }
        )
