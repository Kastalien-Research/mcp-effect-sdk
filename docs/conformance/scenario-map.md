...
| `pnpm run conformance:client-auth` | Client auth conformance against `dist/examples/everything-client.js` | `--suite auth --spec-version 2026-07-28` | Passes on the draft-targeted `@modelcontextprotocol/conformance@0.2.x` path after #20 auth hardening. |
