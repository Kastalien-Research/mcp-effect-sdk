...
| --- | --- | --- | --- | --- | --- | --- | --- |
| GR-CONF-001 | software/protocol correctness | conformance-result | `docs/conformance/sdk-tier-evidence.md` | MCP Tier 1 requires no masked conformance failures. | Passing conformance command result or machine report with zero active failures. | `.local/readiness-evidence/conformance.json`, `docs/conformance/sdk-tier-evidence.md` | `pnpm run conformance:run` |
