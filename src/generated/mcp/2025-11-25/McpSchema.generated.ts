/**
 * Generated from vendored modelcontextprotocol schema.json for MCP 2025-11-25.
...
export class Annotations extends Schema.Class<Annotations>("mcp/generated/2025-11-25/Annotations")(
...
const AudioContentOpenFields = Schema.Struct({
  "_meta": optional(typedObject({  }, [] as const, Schema.Unknown).annotations({
...
export class AudioContent extends Schema.Class<AudioContent>("mcp/generated/2025-11-25/AudioContent")(
...
export class BaseMetadata extends Schema.Class<BaseMetadata>("mcp/generated/2025-11-25/BaseMetadata")(
...
export class BlobResourceContents extends Schema.Class<BlobResourceContents>("mcp/generated/2025-11-25/BlobResourceContents")(
...
export class BooleanSchema extends Schema.Class<BooleanSchema>("mcp/generated/2025-11-25/BooleanSchema")(
...
const TaskMetadataOpenFields = Schema.Struct({
  "ttl": optional(Schema.Int.annotations({
  "description": "Requested duration in milliseconds to retain task from creation."
}))
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const TaskMetadataClassFields = TaskMetadataOpenFields

export class TaskMetadata extends Schema.Class<TaskMetadata>("mcp/generated/2025-11-25/TaskMetadata")(
TaskMetadataClassFields as unknown as Schema.Struct<typeof TaskMetadataOpenFields.fields>, {
  "description": "Metadata for augmenting a request with task execution.\nInclude this in the `task` field of the request parameters."
}
) {
  constructor(props: Schema.Schema.Type<typeof TaskMetadataOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const CallToolRequestParamsOpenFields = Schema.Struct({
  "_meta": optional(typedObject({ "progressToken": optional(ProgressToken.annotations({
  ...
  "task": optional(TaskMetadata.annotations({
...
export class CallToolRequestParams extends Schema.Class<CallToolRequestParams>("mcp/generated/2025-11-25/CallToolRequestParams")(
...
export class CallToolRequest extends Schema.Class<CallToolRequest>("mcp/generated/2025-11-25/CallToolRequest")(
...
export class TextContent extends Schema.Class<TextContent>("mcp/generated/2025-11-25/TextContent")(
...
export class ImageContent extends Schema.Class<ImageContent>("mcp/generated/2025-11-25/ImageContent")(
...
export class Icon extends Schema.Class<Icon>("mcp/generated/2025-11-25/Icon")(
...
export class ResourceLink extends Schema.Class<ResourceLink>("mcp/generated/2025-11-25/ResourceLink")(
...
export class TextResourceContents extends Schema.Class<TextResourceContents>("mcp/generated/2025-11-25/TextResourceContents")(
...
export class EmbeddedResource extends Schema.Class<EmbeddedResource>("mcp/generated/2025-11-25/EmbeddedResource")(
...
const CallToolResultOpenFields = Schema.Struct({
  ...
  "structuredContent": optional(typedObject({  }, [] as const, Schema.Unknown).annotations({
...
export class CallToolResult extends Schema.Class<CallToolResult>("mcp/generated/2025-11-25/CallToolResult")(
...
const CancelledNotificationParamsOpenFields = Schema.Struct({
  ...
  "requestId": optional(RequestId.annotations({
...
export class CancelledNotificationParams extends Schema.Class<CancelledNotificationParams>("mcp/generated/2025-11-25/CancelledNotificationParams")(
...
export class CancelledNotification extends Schema.Class<CancelledNotification>("mcp/generated/2025-11-25/CancelledNotification")(
...
const CancelTaskRequestOpenFields = Schema.Struct({
  "id": RequestId,
  "jsonrpc": Schema.Literal("2.0"),
  "method": Schema.Literal("tasks/cancel"),
  "params": Schema.Struct({ "taskId": Schema.String.annotations({
  "description": "The task identifier to cancel."
}) }, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const CancelTaskRequestClassFields = CancelTaskRequestOpenFields

export class CancelTaskRequest extends Schema.Class<CancelTaskRequest>("mcp/generated/2025-11-25/CancelTaskRequest")(
CancelTaskRequestClassFields as unknown as Schema.Struct<typeof CancelTaskRequestOpenFields.fields>, {
  "description": "A request to cancel a task."
}
) {
  constructor(props: Schema.Schema.Type<typeof CancelTaskRequestOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
export const Result = typedObject({ "_meta": optional(typedObject({  }, [] as const, Schema.Unknown).annotations({
  "description": "See [General fields: `_meta`](/specification/2025-11-25/basic/index#meta) for notes on `_meta` usage."
})) }, [
  "_meta"
] as const, Schema.Unknown)

export const TaskStatus = Schema.Literal("cancelled", "completed", "failed", "input_required", "working").annotations({
  "description": "The status of a task."
})

const TaskOpenFields = Schema.Struct({
  "createdAt": Schema.String.annotations({
  "description": "ISO 8601 timestamp when the task was created."
}),
  "lastUpdatedAt": Schema.String.annotations({
  "description": "ISO 8601 timestamp when the task was last updated."
}),
  "pollInterval": optional(Schema.Int.annotations({
  "description": "Suggested polling interval in milliseconds."
})),
  "status": TaskStatus.annotations({
  "description": "Current task state."
}),
  "statusMessage": optional(Schema.String.annotations({
  ...
  "ttl": Schema.Union(Schema.Int, Schema.Null).annotations({
  "description": "Actual retention duration from creation in milliseconds, null for unlimited."
})
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const TaskClassFields = TaskOpenFields

export class Task extends Schema.Class<Task>("mcp/generated/2025-11-25/Task")(
TaskClassFields as unknown as Schema.Struct<typeof TaskOpenFields.fields>, {
  "description": "Data associated with a task."
}
) {
  constructor(props: Schema.Schema.Type<typeof TaskOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
export const CancelTaskResult = exactIntersection(Result, Task).annotations({
  "description": "The response to a tasks/cancel request."
})

const ClientCapabilitiesOpenFields = Schema.Struct({
  "elicitation": optional(Schema.Struct({ "form": optional(Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown }))), "url": optional(Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown }))) }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
  "description": "Present if the client supports elicitation from the server."
})),
  "experimental": optional(typedObject({  }, [] as const, Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown }))).annotations({
  "description": "Experimental, non-standard capabilities that the client supports."
})),
  "roots": optional(Schema.Struct({ "listChanged": optional(Schema.Boolean.annotations({
  "description": "Whether the client supports notifications for changes to the roots list."
})) }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
  "description": "Present if the client supports listing roots."
})),
  "sampling": optional(Schema.Struct({ "context": optional(Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
  "description": "Whether the client supports context inclusion via includeContext parameter.\nIf not declared, servers SHOULD only use `includeContext: \"none\"` (or omit it)."
})), "tools": optional(Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
  "description": "Whether the client supports tool use via tools and toolChoice parameters."
})) }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
  "description": "Present if the client supports sampling from an LLM."
})),
  "tasks": optional(Schema.Struct({ "cancel": optional(Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
  "description": "Whether this client supports tasks/cancel."
})), "list": optional(Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
  "description": "Whether this client supports tasks/list."
})), "requests": optional(Schema.Struct({ "elicitation": optional(Schema.Struct({ "create": optional(Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
...
})), "sampling": optional(Schema.Struct({ "createMessage": optional(Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
...
export class ClientCapabilities extends Schema.Class<ClientCapabilities>("mcp/generated/2025-11-25/ClientCapabilities")(
...
export class NotificationParams extends Schema.Class<NotificationParams>("mcp/generated/2025-11-25/NotificationParams")(
...
const InitializedNotificationOpenFields = Schema.Struct({
  "jsonrpc": Schema.Literal("2.0"),
  "method": Schema.Literal("notifications/initialized"),
  "params": optional(NotificationParams)
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const InitializedNotificationClassFields = InitializedNotificationOpenFields

export class InitializedNotification extends Schema.Class<InitializedNotification>("mcp/generated/2025-11-25/InitializedNotification")(
InitializedNotificationClassFields as unknown as Schema.Struct<typeof InitializedNotificationOpenFields.fields>, {
  "description": "This notification is sent from the client to the server after initialization has finished."
}
) {
  constructor(props: Schema.Schema.Type<typeof InitializedNotificationOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
export class ProgressNotificationParams extends Schema.Class<ProgressNotificationParams>("mcp/generated/2025-11-25/ProgressNotificationParams")(
...
export class ProgressNotification extends Schema.Class<ProgressNotification>("mcp/generated/2025-11-25/ProgressNotification")(
...
export const TaskStatusNotificationParams = exactIntersection(NotificationParams, Task).annotations({
  "description": "Parameters for a `notifications/tasks/status` notification."
})

const TaskStatusNotificationOpenFields = Schema.Struct({
  "jsonrpc": Schema.Literal("2.0"),
  "method": Schema.Literal("notifications/tasks/status"),
  "params": TaskStatusNotificationParams
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const TaskStatusNotificationClassFields = TaskStatusNotificationOpenFields

export class TaskStatusNotification extends Schema.Class<TaskStatusNotification>("mcp/generated/2025-11-25/TaskStatusNotification")(
TaskStatusNotificationClassFields as unknown as Schema.Struct<typeof TaskStatusNotificationOpenFields.fields>, {
  ...
  constructor(props: Schema.Schema.Type<typeof TaskStatusNotificationOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const RootsListChangedNotificationOpenFields = Schema.Struct({
  "jsonrpc": Schema.Literal("2.0"),
  "method": Schema.Literal("notifications/roots/list_changed"),
  "params": optional(NotificationParams)
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const RootsListChangedNotificationClassFields = RootsListChangedNotificationOpenFields

export class RootsListChangedNotification extends Schema.Class<RootsListChangedNotification>("mcp/generated/2025-11-25/RootsListChangedNotification")(
RootsListChangedNotificationClassFields as unknown as Schema.Struct<typeof RootsListChangedNotificationOpenFields.fields>, {
  ...
  constructor(props: Schema.Schema.Type<typeof RootsListChangedNotificationOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
export const ClientNotification = Schema.Union(CancelledNotification, ProgressNotification, InitializedNotification, RootsListChangedNotification, TaskStatusNotification)
...
export class Implementation extends Schema.Class<Implementation>("mcp/generated/2025-11-25/Implementation")(
...
const InitializeRequestParamsOpenFields = Schema.Struct({
  "_meta": optional(typedObject({ "progressToken": optional(ProgressToken.annotations({
  "description": "If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications."
})) }, [
  "progressToken"
  ...
  "protocolVersion": Schema.String.annotations({
...
const InitializeRequestParamsClassFields = InitializeRequestParamsOpenFields

export class InitializeRequestParams extends Schema.Class<InitializeRequestParams>("mcp/generated/2025-11-25/InitializeRequestParams")(
InitializeRequestParamsClassFields as unknown as Schema.Struct<typeof InitializeRequestParamsOpenFields.fields>, {
  "description": "Parameters for an `initialize` request."
}
) {
  constructor(props: Schema.Schema.Type<typeof InitializeRequestParamsOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const InitializeRequestOpenFields = Schema.Struct({
  "id": RequestId,
  "jsonrpc": Schema.Literal("2.0"),
  "method": Schema.Literal("initialize"),
  "params": InitializeRequestParams
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const InitializeRequestClassFields = InitializeRequestOpenFields

export class InitializeRequest extends Schema.Class<InitializeRequest>("mcp/generated/2025-11-25/InitializeRequest")(
InitializeRequestClassFields as unknown as Schema.Struct<typeof InitializeRequestOpenFields.fields>, {
  "description": "This request is sent from the client to the server when it first connects, asking it to begin initialization."
}
) {
  constructor(props: Schema.Schema.Type<typeof InitializeRequestOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
export class RequestParams extends Schema.Class<RequestParams>("mcp/generated/2025-11-25/RequestParams")(
...
const PingRequestOpenFields = Schema.Struct({
  "id": RequestId,
  "jsonrpc": Schema.Literal("2.0"),
  "method": Schema.Literal("ping"),
  "params": optional(RequestParams)
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const PingRequestClassFields = PingRequestOpenFields

export class PingRequest extends Schema.Class<PingRequest>("mcp/generated/2025-11-25/PingRequest")(
PingRequestClassFields as unknown as Schema.Struct<typeof PingRequestOpenFields.fields>, {
  ...
  constructor(props: Schema.Schema.Type<typeof PingRequestOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
export class PaginatedRequestParams extends Schema.Class<PaginatedRequestParams>("mcp/generated/2025-11-25/PaginatedRequestParams")(
...
const ListResourcesRequestOpenFields = Schema.Struct({
  ...
  "params": optional(PaginatedRequestParams)
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const ListResourcesRequestClassFields = ListResourcesRequestOpenFields

export class ListResourcesRequest extends Schema.Class<ListResourcesRequest>("mcp/generated/2025-11-25/ListResourcesRequest")(
...
export class ListResourceTemplatesRequest extends Schema.Class<ListResourceTemplatesRequest>("mcp/generated/2025-11-25/ListResourceTemplatesRequest")(
...
export class ReadResourceRequestParams extends Schema.Class<ReadResourceRequestParams>("mcp/generated/2025-11-25/ReadResourceRequestParams")(
...
export class ReadResourceRequest extends Schema.Class<ReadResourceRequest>("mcp/generated/2025-11-25/ReadResourceRequest")(
...
const SubscribeRequestParamsOpenFields = Schema.Struct({
  "_meta": optional(typedObject({ "progressToken": optional(ProgressToken.annotations({
  "description": "If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications."
})) }, [
  "progressToken"
...
const SubscribeRequestParamsClassFields = SubscribeRequestParamsOpenFields

export class SubscribeRequestParams extends Schema.Class<SubscribeRequestParams>("mcp/generated/2025-11-25/SubscribeRequestParams")(
SubscribeRequestParamsClassFields as unknown as Schema.Struct<typeof SubscribeRequestParamsOpenFields.fields>, {
  "description": "Parameters for a `resources/subscribe` request."
}
) {
  constructor(props: Schema.Schema.Type<typeof SubscribeRequestParamsOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const SubscribeRequestOpenFields = Schema.Struct({
  "id": RequestId,
  "jsonrpc": Schema.Literal("2.0"),
  "method": Schema.Literal("resources/subscribe"),
  "params": SubscribeRequestParams
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const SubscribeRequestClassFields = SubscribeRequestOpenFields

export class SubscribeRequest extends Schema.Class<SubscribeRequest>("mcp/generated/2025-11-25/SubscribeRequest")(
SubscribeRequestClassFields as unknown as Schema.Struct<typeof SubscribeRequestOpenFields.fields>, {
  ...
  constructor(props: Schema.Schema.Type<typeof SubscribeRequestOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const UnsubscribeRequestParamsOpenFields = Schema.Struct({
  "_meta": optional(typedObject({ "progressToken": optional(ProgressToken.annotations({
  "description": "If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications."
})) }, [
  "progressToken"
...
const UnsubscribeRequestParamsClassFields = UnsubscribeRequestParamsOpenFields

export class UnsubscribeRequestParams extends Schema.Class<UnsubscribeRequestParams>("mcp/generated/2025-11-25/UnsubscribeRequestParams")(
UnsubscribeRequestParamsClassFields as unknown as Schema.Struct<typeof UnsubscribeRequestParamsOpenFields.fields>, {
  "description": "Parameters for a `resources/unsubscribe` request."
}
) {
  constructor(props: Schema.Schema.Type<typeof UnsubscribeRequestParamsOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const UnsubscribeRequestOpenFields = Schema.Struct({
  "id": RequestId,
  "jsonrpc": Schema.Literal("2.0"),
  "method": Schema.Literal("resources/unsubscribe"),
  "params": UnsubscribeRequestParams
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const UnsubscribeRequestClassFields = UnsubscribeRequestOpenFields

export class UnsubscribeRequest extends Schema.Class<UnsubscribeRequest>("mcp/generated/2025-11-25/UnsubscribeRequest")(
UnsubscribeRequestClassFields as unknown as Schema.Struct<typeof UnsubscribeRequestOpenFields.fields>, {
  ...
  constructor(props: Schema.Schema.Type<typeof UnsubscribeRequestOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
export class ListPromptsRequest extends Schema.Class<ListPromptsRequest>("mcp/generated/2025-11-25/ListPromptsRequest")(
...
export class GetPromptRequestParams extends Schema.Class<GetPromptRequestParams>("mcp/generated/2025-11-25/GetPromptRequestParams")(
...
export class GetPromptRequest extends Schema.Class<GetPromptRequest>("mcp/generated/2025-11-25/GetPromptRequest")(
...
export class ListToolsRequest extends Schema.Class<ListToolsRequest>("mcp/generated/2025-11-25/ListToolsRequest")(
...
const GetTaskRequestOpenFields = Schema.Struct({
  "id": RequestId,
  "jsonrpc": Schema.Literal("2.0"),
...
const GetTaskRequestClassFields = GetTaskRequestOpenFields

export class GetTaskRequest extends Schema.Class<GetTaskRequest>("mcp/generated/2025-11-25/GetTaskRequest")(
GetTaskRequestClassFields as unknown as Schema.Struct<typeof GetTaskRequestOpenFields.fields>, {
  "description": "A request to retrieve the state of a task."
}
) {
  constructor(props: Schema.Schema.Type<typeof GetTaskRequestOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const GetTaskPayloadRequestOpenFields = Schema.Struct({
  "id": RequestId,
  "jsonrpc": Schema.Literal("2.0"),
  "method": Schema.Literal("tasks/result"),
  "params": Schema.Struct({ "taskId": Schema.String.annotations({
  "description": "The task identifier to retrieve results for."
}) }, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const GetTaskPayloadRequestClassFields = GetTaskPayloadRequestOpenFields

export class GetTaskPayloadRequest extends Schema.Class<GetTaskPayloadRequest>("mcp/generated/2025-11-25/GetTaskPayloadRequest")(
GetTaskPayloadRequestClassFields as unknown as Schema.Struct<typeof GetTaskPayloadRequestOpenFields.fields>, {
  "description": "A request to retrieve the result of a completed task."
}
) {
  constructor(props: Schema.Schema.Type<typeof GetTaskPayloadRequestOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const ListTasksRequestOpenFields = Schema.Struct({
  "id": RequestId,
  "jsonrpc": Schema.Literal("2.0"),
  "method": Schema.Literal("tasks/list"),
  "params": optional(PaginatedRequestParams)
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const ListTasksRequestClassFields = ListTasksRequestOpenFields

export class ListTasksRequest extends Schema.Class<ListTasksRequest>("mcp/generated/2025-11-25/ListTasksRequest")(
ListTasksRequestClassFields as unknown as Schema.Struct<typeof ListTasksRequestOpenFields.fields>, {
  "description": "A request to retrieve a list of tasks."
}
) {
  constructor(props: Schema.Schema.Type<typeof ListTasksRequestOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const SetLevelRequestParamsOpenFields = Schema.Struct({
  "_meta": optional(typedObject({ "progressToken": optional(ProgressToken.annotations({
  "description": "If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications."
})) }, [
  "progressToken"
...
const SetLevelRequestParamsClassFields = SetLevelRequestParamsOpenFields

export class SetLevelRequestParams extends Schema.Class<SetLevelRequestParams>("mcp/generated/2025-11-25/SetLevelRequestParams")(
SetLevelRequestParamsClassFields as unknown as Schema.Struct<typeof SetLevelRequestParamsOpenFields.fields>, {
  "description": "Parameters for a `logging/setLevel` request."
}
) {
  constructor(props: Schema.Schema.Type<typeof SetLevelRequestParamsOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const SetLevelRequestOpenFields = Schema.Struct({
  "id": RequestId,
  "jsonrpc": Schema.Literal("2.0"),
  "method": Schema.Literal("logging/setLevel"),
  "params": SetLevelRequestParams
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const SetLevelRequestClassFields = SetLevelRequestOpenFields

export class SetLevelRequest extends Schema.Class<SetLevelRequest>("mcp/generated/2025-11-25/SetLevelRequest")(
SetLevelRequestClassFields as unknown as Schema.Struct<typeof SetLevelRequestOpenFields.fields>, {
  "description": "A request from the client to the server, to enable or adjust logging."
}
) {
  constructor(props: Schema.Schema.Type<typeof SetLevelRequestOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
export class PromptReference extends Schema.Class<PromptReference>("mcp/generated/2025-11-25/PromptReference")(
...
export class ResourceTemplateReference extends Schema.Class<ResourceTemplateReference>("mcp/generated/2025-11-25/ResourceTemplateReference")(
...
export class CompleteRequestParams extends Schema.Class<CompleteRequestParams>("mcp/generated/2025-11-25/CompleteRequestParams")(
...
export class CompleteRequest extends Schema.Class<CompleteRequest>("mcp/generated/2025-11-25/CompleteRequest")(
...
export const ClientRequest = Schema.Union(PingRequest, InitializeRequest, CompleteRequest, SetLevelRequest, GetPromptRequest, ListPromptsRequest, ListResourcesRequest, ListResourceTemplatesRequest, ReadResourceRequest, SubscribeRequest, UnsubscribeRequest, CallToolRequest, ListToolsRequest, GetTaskRequest, GetTaskPayloadRequest, ListTasksRequest, CancelTaskRequest)

export const GetTaskResult = exactIntersection(Result, Task).annotations({
  "description": "The response to a tasks/get request."
})

const GetTaskPayloadResultOpenFields = Schema.Struct({
  "_meta": optional(typedObject({  }, [] as const, Schema.Unknown).annotations({
  "description": "See [General fields: `_meta`](/specification/2025-11-25/basic/index#meta) for notes on `_meta` usage."
}))
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const GetTaskPayloadResultClassFields = GetTaskPayloadResultOpenFields

export class GetTaskPayloadResult extends Schema.Class<GetTaskPayloadResult>("mcp/generated/2025-11-25/GetTaskPayloadResult")(
GetTaskPayloadResultClassFields as unknown as Schema.Struct<typeof GetTaskPayloadResultOpenFields.fields>, {
  "description": "The response to a tasks/result request.\nThe structure matches the result type of the original request.\nFor example, a tools/call task would return the CallToolResult structure."
}
) {
  constructor(props: Schema.Schema.Type<typeof GetTaskPayloadResultOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const ListTasksResultOpenFields = Schema.Struct({
  "_meta": optional(typedObject({  }, [] as const, Schema.Unknown).annotations({
  "description": "See [General fields: `_meta`](/specification/2025-11-25/basic/index#meta) for notes on `_meta` usage."
})),
...
const ListTasksResultClassFields = ListTasksResultOpenFields

export class ListTasksResult extends Schema.Class<ListTasksResult>("mcp/generated/2025-11-25/ListTasksResult")(
ListTasksResultClassFields as unknown as Schema.Struct<typeof ListTasksResultOpenFields.fields>, {
  "description": "The response to a tasks/list request."
}
) {
  constructor(props: Schema.Schema.Type<typeof ListTasksResultOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
export class ToolUseContent extends Schema.Class<ToolUseContent>("mcp/generated/2025-11-25/ToolUseContent")(
...
export class ToolResultContent extends Schema.Class<ToolResultContent>("mcp/generated/2025-11-25/ToolResultContent")(
...
export class CreateMessageResult extends Schema.Class<CreateMessageResult>("mcp/generated/2025-11-25/CreateMessageResult")(
...
export class Root extends Schema.Class<Root>("mcp/generated/2025-11-25/Root")(
...
export class ListRootsResult extends Schema.Class<ListRootsResult>("mcp/generated/2025-11-25/ListRootsResult")(
...
const ElicitResultOpenFields = Schema.Struct({
  ...
  "content": optional(typedObject({  }, [] as const, Schema.Union(Schema.Array(Schema.String), Schema.Union(Schema.String, Schema.Finite, Schema.Boolean))).annotations({
...
export class ElicitResult extends Schema.Class<ElicitResult>("mcp/generated/2025-11-25/ElicitResult")(
...
export const EmptyResult = typedObject({ "_meta": optional(typedObject({  }, [] as const, Schema.Unknown).annotations({
  "description": "See [General fields: `_meta`](/specification/2025-11-25/basic/index#meta) for notes on `_meta` usage."
})), "resultType": optional(Schema.Literal("complete")) }, [
  "_meta",
  "resultType"
] as const, Schema.Unknown)

export const ClientResult = Schema.Union(EmptyResult, CreateMessageResult, ListRootsResult, ElicitResult, GetTaskResult, GetTaskPayloadResult, ListTasksResult, CancelTaskResult)
...
})), "values": Schema.Array(Schema.String).annotations({
  "description": "An array of completion values. Must not exceed 100 items."
}) }, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const CompleteResultClassFields = CompleteResultOpenFields

export class CompleteResult extends Schema.Class<CompleteResult>("mcp/generated/2025-11-25/CompleteResult")(
...
export class SamplingMessage extends Schema.Class<SamplingMessage>("mcp/generated/2025-11-25/SamplingMessage")(
...
export class ModelHint extends Schema.Class<ModelHint>("mcp/generated/2025-11-25/ModelHint")(
...
export class ModelPreferences extends Schema.Class<ModelPreferences>("mcp/generated/2025-11-25/ModelPreferences")(
...
export class ToolChoice extends Schema.Class<ToolChoice>("mcp/generated/2025-11-25/ToolChoice")(
...
export class ToolAnnotations extends Schema.Class<ToolAnnotations>("mcp/generated/2025-11-25/ToolAnnotations")(
...
const ToolExecutionOpenFields = Schema.Struct({
  "taskSupport": optional(Schema.Literal("forbidden", "optional", "required").annotations({
...
const ToolExecutionClassFields = ToolExecutionOpenFields

export class ToolExecution extends Schema.Class<ToolExecution>("mcp/generated/2025-11-25/ToolExecution")(
ToolExecutionClassFields as unknown as Schema.Struct<typeof ToolExecutionOpenFields.fields>, {
  "description": "Execution-related properties for a tool."
}
) {
  constructor(props: Schema.Schema.Type<typeof ToolExecutionOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const ToolOpenFields = Schema.Struct({
  ...
  "execution": optional(ToolExecution.annotations({
  "description": "Execution-related properties for this tool."
})),
  "icons": optional(Schema.Array(Icon).annotations({
  "description": "Optional set of sized icons that the client can display in a user interface.\n\nClients that support rendering icons MUST support at least the following MIME types:\n- `image/png` - PNG images (safe, universal compatibility)\n- `image/jpeg` (and `image/jpg`) - JPEG images (safe, universal compatibility)\n\nClients that support rendering icons SHOULD also support:\n- `image/svg+xml` - SVG images (scalable but requires security precautions)\n- `image/webp` - WebP images (modern, efficient format)"
})),
  "inputSchema": Schema.Struct({ "$schema": optional(Schema.String), "properties": optional(typedObject({  }, [] as const, Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown })))), "required": optional(Schema.Array(Schema.String)), "type": Schema.Literal("object") }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
  "description": "A JSON Schema object defining the expected parameters for the tool."
}),
  "name": Schema.String.annotations({
  "description": "Intended for programmatic or logical use, but used as a display name in past specs or fallback (if title isn't present)."
}),
  "outputSchema": optional(Schema.Struct({ "$schema": optional(Schema.String), "properties": optional(typedObject({  }, [] as const, Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown })))), "required": optional(Schema.Array(Schema.String)), "type": Schema.Literal("object") }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
...
export class Tool extends Schema.Class<Tool>("mcp/generated/2025-11-25/Tool")(
...
const CreateMessageRequestParamsOpenFields = Schema.Struct({
  ...
  "metadata": optional(Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
...
export class CreateMessageRequestParams extends Schema.Class<CreateMessageRequestParams>("mcp/generated/2025-11-25/CreateMessageRequestParams")(
...
export class CreateMessageRequest extends Schema.Class<CreateMessageRequest>("mcp/generated/2025-11-25/CreateMessageRequest")(
...
const CreateTaskResultOpenFields = Schema.Struct({
  "_meta": optional(typedObject({  }, [] as const, Schema.Unknown).annotations({
  "description": "See [General fields: `_meta`](/specification/2025-11-25/basic/index#meta) for notes on `_meta` usage."
})),
  "task": Task
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const CreateTaskResultClassFields = CreateTaskResultOpenFields

export class CreateTaskResult extends Schema.Class<CreateTaskResult>("mcp/generated/2025-11-25/CreateTaskResult")(
CreateTaskResultClassFields as unknown as Schema.Struct<typeof CreateTaskResultOpenFields.fields>, {
  "description": "A response to a task-augmented request."
}
) {
  constructor(props: Schema.Schema.Type<typeof CreateTaskResultOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const ElicitationCompleteNotificationOpenFields = Schema.Struct({
  "jsonrpc": Schema.Literal("2.0"),
  "method": Schema.Literal("notifications/elicitation/complete"),
  "params": Schema.Struct({ "elicitationId": Schema.String.annotations({
  "description": "The ID of the elicitation that completed."
}) }, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const ElicitationCompleteNotificationClassFields = ElicitationCompleteNotificationOpenFields

export class ElicitationCompleteNotification extends Schema.Class<ElicitationCompleteNotification>("mcp/generated/2025-11-25/ElicitationCompleteNotification")(
ElicitationCompleteNotificationClassFields as unknown as Schema.Struct<typeof ElicitationCompleteNotificationOpenFields.fields>, {
  ...
  constructor(props: Schema.Schema.Type<typeof ElicitationCompleteNotificationOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const ElicitRequestURLParamsOpenFields = Schema.Struct({
  ...
  "elicitationId": Schema.String.annotations({
...
export class ElicitRequestURLParams extends Schema.Class<ElicitRequestURLParams>("mcp/generated/2025-11-25/ElicitRequestURLParams")(
...
export class StringSchema extends Schema.Class<StringSchema>("mcp/generated/2025-11-25/StringSchema")(
...
export class NumberSchema extends Schema.Class<NumberSchema>("mcp/generated/2025-11-25/NumberSchema")(
...
export class UntitledSingleSelectEnumSchema extends Schema.Class<UntitledSingleSelectEnumSchema>("mcp/generated/2025-11-25/UntitledSingleSelectEnumSchema")(
...
export class TitledSingleSelectEnumSchema extends Schema.Class<TitledSingleSelectEnumSchema>("mcp/generated/2025-11-25/TitledSingleSelectEnumSchema")(
...
export class UntitledMultiSelectEnumSchema extends Schema.Class<UntitledMultiSelectEnumSchema>("mcp/generated/2025-11-25/UntitledMultiSelectEnumSchema")(
...
export class TitledMultiSelectEnumSchema extends Schema.Class<TitledMultiSelectEnumSchema>("mcp/generated/2025-11-25/TitledMultiSelectEnumSchema")(
...
export class LegacyTitledEnumSchema extends Schema.Class<LegacyTitledEnumSchema>("mcp/generated/2025-11-25/LegacyTitledEnumSchema")(
...
export class ElicitRequestFormParams extends Schema.Class<ElicitRequestFormParams>("mcp/generated/2025-11-25/ElicitRequestFormParams")(
...
export class ElicitRequest extends Schema.Class<ElicitRequest>("mcp/generated/2025-11-25/ElicitRequest")(
...
export class Error extends Schema.Class<Error>("mcp/generated/2025-11-25/Error")(
...
export class PromptMessage extends Schema.Class<PromptMessage>("mcp/generated/2025-11-25/PromptMessage")(
...
export class GetPromptResult extends Schema.Class<GetPromptResult>("mcp/generated/2025-11-25/GetPromptResult")(
...
export class Icons extends Schema.Class<Icons>("mcp/generated/2025-11-25/Icons")(
...
const ServerCapabilitiesOpenFields = Schema.Struct({
  "completions": optional(Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
  "description": "Present if the server supports argument autocompletion suggestions."
})),
  "experimental": optional(typedObject({  }, [] as const, Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown }))).annotations({
  "description": "Experimental, non-standard capabilities that the server supports."
})),
  "logging": optional(Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
...
})), "requests": optional(Schema.Struct({ "tools": optional(Schema.Struct({ "call": optional(Schema.Struct({  }, Schema.Record({ key: Schema.String, value: Schema.Unknown })).annotations({
...
export class ServerCapabilities extends Schema.Class<ServerCapabilities>("mcp/generated/2025-11-25/ServerCapabilities")(
...
const InitializeResultOpenFields = Schema.Struct({
  "_meta": optional(typedObject({  }, [] as const, Schema.Unknown).annotations({
  "description": "See [General fields: `_meta`](/specification/2025-11-25/basic/index#meta) for notes on `_meta` usage."
})),
...
const InitializeResultClassFields = InitializeResultOpenFields

export class InitializeResult extends Schema.Class<InitializeResult>("mcp/generated/2025-11-25/InitializeResult")(
InitializeResultClassFields as unknown as Schema.Struct<typeof InitializeResultOpenFields.fields>, {
  "description": "After receiving an initialize request from the client, the server sends this response."
}
) {
  constructor(props: Schema.Schema.Type<typeof InitializeResultOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
export class JSONRPCErrorResponse extends Schema.Class<JSONRPCErrorResponse>("mcp/generated/2025-11-25/JSONRPCErrorResponse")(
...
export class JSONRPCRequest extends Schema.Class<JSONRPCRequest>("mcp/generated/2025-11-25/JSONRPCRequest")(
...
export class JSONRPCNotification extends Schema.Class<JSONRPCNotification>("mcp/generated/2025-11-25/JSONRPCNotification")(
...
export class JSONRPCResultResponse extends Schema.Class<JSONRPCResultResponse>("mcp/generated/2025-11-25/JSONRPCResultResponse")(
...
export class PromptArgument extends Schema.Class<PromptArgument>("mcp/generated/2025-11-25/PromptArgument")(
...
export class Prompt extends Schema.Class<Prompt>("mcp/generated/2025-11-25/Prompt")(
...
export class ListPromptsResult extends Schema.Class<ListPromptsResult>("mcp/generated/2025-11-25/ListPromptsResult")(
...
export class Resource extends Schema.Class<Resource>("mcp/generated/2025-11-25/Resource")(
...
export class ListResourcesResult extends Schema.Class<ListResourcesResult>("mcp/generated/2025-11-25/ListResourcesResult")(
...
export class ResourceTemplate extends Schema.Class<ResourceTemplate>("mcp/generated/2025-11-25/ResourceTemplate")(
...
export class ListResourceTemplatesResult extends Schema.Class<ListResourceTemplatesResult>("mcp/generated/2025-11-25/ListResourceTemplatesResult")(
...
export const ListRootsRequestParams = RequestParams
...
export class ListRootsRequest extends Schema.Class<ListRootsRequest>("mcp/generated/2025-11-25/ListRootsRequest")(
...
export class ListToolsResult extends Schema.Class<ListToolsResult>("mcp/generated/2025-11-25/ListToolsResult")(
...
export class LoggingMessageNotificationParams extends Schema.Class<LoggingMessageNotificationParams>("mcp/generated/2025-11-25/LoggingMessageNotificationParams")(
...
export class LoggingMessageNotification extends Schema.Class<LoggingMessageNotification>("mcp/generated/2025-11-25/LoggingMessageNotification")(
...
export class Notification extends Schema.Class<Notification>("mcp/generated/2025-11-25/Notification")(
...
export class PaginatedRequest extends Schema.Class<PaginatedRequest>("mcp/generated/2025-11-25/PaginatedRequest")(
...
export class PaginatedResult extends Schema.Class<PaginatedResult>("mcp/generated/2025-11-25/PaginatedResult")(
...
export class PromptListChangedNotification extends Schema.Class<PromptListChangedNotification>("mcp/generated/2025-11-25/PromptListChangedNotification")(
...
export class ReadResourceResult extends Schema.Class<ReadResourceResult>("mcp/generated/2025-11-25/ReadResourceResult")(
...
const RelatedTaskMetadataOpenFields = Schema.Struct({
  "taskId": Schema.String.annotations({
  "description": "The task identifier this message is associated with."
})
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const RelatedTaskMetadataClassFields = RelatedTaskMetadataOpenFields

export class RelatedTaskMetadata extends Schema.Class<RelatedTaskMetadata>("mcp/generated/2025-11-25/RelatedTaskMetadata")(
RelatedTaskMetadataClassFields as unknown as Schema.Struct<typeof RelatedTaskMetadataOpenFields.fields>, {
  "description": "Metadata for associating messages with a task.\nInclude this in the `_meta` field under the key `io.modelcontextprotocol/related-task`."
}
) {
  constructor(props: Schema.Schema.Type<typeof RelatedTaskMetadataOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
export class Request extends Schema.Class<Request>("mcp/generated/2025-11-25/Request")(
...
export class ResourceContents extends Schema.Class<ResourceContents>("mcp/generated/2025-11-25/ResourceContents")(
...
export class ResourceListChangedNotification extends Schema.Class<ResourceListChangedNotification>("mcp/generated/2025-11-25/ResourceListChangedNotification")(
...
export class ResourceRequestParams extends Schema.Class<ResourceRequestParams>("mcp/generated/2025-11-25/ResourceRequestParams")(
...
export class ResourceUpdatedNotificationParams extends Schema.Class<ResourceUpdatedNotificationParams>("mcp/generated/2025-11-25/ResourceUpdatedNotificationParams")(
...
export class ResourceUpdatedNotification extends Schema.Class<ResourceUpdatedNotification>("mcp/generated/2025-11-25/ResourceUpdatedNotification")(
...
export class ToolListChangedNotification extends Schema.Class<ToolListChangedNotification>("mcp/generated/2025-11-25/ToolListChangedNotification")(
...
export const ServerNotification = Schema.Union(CancelledNotification, ProgressNotification, LoggingMessageNotification, ResourceUpdatedNotification, ResourceListChangedNotification, ToolListChangedNotification, PromptListChangedNotification, ElicitationCompleteNotification, TaskStatusNotification)

export const ServerRequest = Schema.Union(PingRequest, CreateMessageRequest, ListRootsRequest, ElicitRequest, GetTaskRequest, GetTaskPayloadRequest, ListTasksRequest, CancelTaskRequest)

export const ServerResult = Schema.Union(EmptyResult, InitializeResult, CompleteResult, GetPromptResult, ListPromptsResult, ListResourceTemplatesResult, ListResourcesResult, ReadResourceResult, CallToolResult, ListToolsResult, GetTaskResult, GetTaskPayloadResult, ListTasksResult, CancelTaskResult)

const TaskAugmentedRequestParamsOpenFields = Schema.Struct({
  "_meta": optional(typedObject({ "progressToken": optional(ProgressToken.annotations({
  "description": "If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications."
})) }, [
  "progressToken"
...
const TaskAugmentedRequestParamsClassFields = TaskAugmentedRequestParamsOpenFields

export class TaskAugmentedRequestParams extends Schema.Class<TaskAugmentedRequestParams>("mcp/generated/2025-11-25/TaskAugmentedRequestParams")(
TaskAugmentedRequestParamsClassFields as unknown as Schema.Struct<typeof TaskAugmentedRequestParamsOpenFields.fields>, {
  "description": "Common params for any task-augmented request."
}
) {
  constructor(props: Schema.Schema.Type<typeof TaskAugmentedRequestParamsOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const URLElicitationRequiredErrorOpenFields = Schema.Struct({
  "error": exactIntersection(Error, Schema.Struct({ "code": Schema.Literal(-32042), "data": typedObject({ "elicitations": Schema.Array(ElicitRequestURLParams) }, [
  "elicitations"
] as const, Schema.Unknown) }, Schema.Record({ key: Schema.String, value: Schema.Unknown }))),
  "id": optional(RequestId),
  "jsonrpc": Schema.Literal("2.0")
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const URLElicitationRequiredErrorClassFields = URLElicitationRequiredErrorOpenFields

export class URLElicitationRequiredError extends Schema.Class<URLElicitationRequiredError>("mcp/generated/2025-11-25/URLElicitationRequiredError")(
URLElicitationRequiredErrorClassFields as unknown as Schema.Struct<typeof URLElicitationRequiredErrorOpenFields.fields>, {
  ...
  constructor(props: Schema.Schema.Type<typeof URLElicitationRequiredErrorOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const GetTaskRequestParamsOpenFields = Schema.Struct({
  "taskId": Schema.String.annotations({
  "description": "The task identifier to query."
})
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const GetTaskRequestParamsClassFields = GetTaskRequestParamsOpenFields

export class GetTaskRequestParams extends Schema.Class<GetTaskRequestParams>("mcp/generated/2025-11-25/GetTaskRequestParams")(
GetTaskRequestParamsClassFields as unknown as Schema.Struct<typeof GetTaskRequestParamsOpenFields.fields>
) {
  constructor(props: Schema.Schema.Type<typeof GetTaskRequestParamsOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const GetTaskPayloadRequestParamsOpenFields = Schema.Struct({
  "taskId": Schema.String.annotations({
  "description": "The task identifier to retrieve results for."
})
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const GetTaskPayloadRequestParamsClassFields = GetTaskPayloadRequestParamsOpenFields

export class GetTaskPayloadRequestParams extends Schema.Class<GetTaskPayloadRequestParams>("mcp/generated/2025-11-25/GetTaskPayloadRequestParams")(
GetTaskPayloadRequestParamsClassFields as unknown as Schema.Struct<typeof GetTaskPayloadRequestParamsOpenFields.fields>
) {
  constructor(props: Schema.Schema.Type<typeof GetTaskPayloadRequestParamsOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const CancelTaskRequestParamsOpenFields = Schema.Struct({
  "taskId": Schema.String.annotations({
  "description": "The task identifier to cancel."
})
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const CancelTaskRequestParamsClassFields = CancelTaskRequestParamsOpenFields

export class CancelTaskRequestParams extends Schema.Class<CancelTaskRequestParams>("mcp/generated/2025-11-25/CancelTaskRequestParams")(
CancelTaskRequestParamsClassFields as unknown as Schema.Struct<typeof CancelTaskRequestParamsOpenFields.fields>
) {
  constructor(props: Schema.Schema.Type<typeof CancelTaskRequestParamsOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
const ElicitationCompleteNotificationParamsOpenFields = Schema.Struct({
  "elicitationId": Schema.String.annotations({
  "description": "The ID of the elicitation that completed."
})
}, Schema.Record({ key: Schema.String, value: Schema.Unknown }))
const ElicitationCompleteNotificationParamsClassFields = ElicitationCompleteNotificationParamsOpenFields

export class ElicitationCompleteNotificationParams extends Schema.Class<ElicitationCompleteNotificationParams>("mcp/generated/2025-11-25/ElicitationCompleteNotificationParams")(
ElicitationCompleteNotificationParamsClassFields as unknown as Schema.Struct<typeof ElicitationCompleteNotificationParamsOpenFields.fields>
) {
  constructor(props: Schema.Schema.Type<typeof ElicitationCompleteNotificationParamsOpenFields>, options?: Schema.MakeOptions) {
    super(props, options)
  }
...
export const MCP_SCHEMA_CODECS = {
  ...
  "Task": Task,
  "TaskAugmentedRequestParams": TaskAugmentedRequestParams,
  ...
  "GetTaskRequestParams": GetTaskRequestParams,
  "GetTaskPayloadRequestParams": GetTaskPayloadRequestParams,
  "CancelTaskRequestParams": CancelTaskRequestParams,
  "ElicitationCompleteNotificationParams": ElicitationCompleteNotificationParams
